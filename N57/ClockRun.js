...
var CLOCK_HOURHAND_WIDTH_HALF = (CLOCK_HOURHAND_WIDTH / 2); // половина ширины часовой стрелки
var CLOCK_HOURHAND_HEIGTH = 50; // длина часовой стрелки
var CLOCK_HOURHAND_HEIGTH_HALF = (CLOCK_HOURHAND_HEIGTH / 2); // половина длины часовой стрелки
var CLOCK_HOURHAND_COLOR = '#000'; // цвет часовой стрелки

var CLOCK_MINUTEHAND_WIDTH = 6; // толщина минутной стрелки
var CLOCK_MINUTEHAND_WIDTH_HALF = (CLOCK_MINUTEHAND_WIDTH / 2); // половина ширины минутной стрелки
var CLOCK_MINUTEHAND_HEIGTH = 75; // длина минутной стрелки
var CLOCK_MINUTEHAND_HEIGTH_HALF = (CLOCK_MINUTEHAND_HEIGTH / 2); // половина длины минутной стрелки
var CLOCK_MINUTEHAND_COLOR = '#000'; // цвет минутной стрелки

var CLOCK_SECONDHAND_WIDTH = 2; // толщина секундной стрелки
var CLOCK_SECONDHAND_WIDTH_HALF = (CLOCK_SECONDHAND_WIDTH / 2); // половина ширины секундной стрелки
var CLOCK_SECONDHAND_HEIGTH = 90; // длина секундной стрелки
var CLOCK_SECONDHAND_HEIGTH_HALF = (CLOCK_SECONDHAND_HEIGTH / 2); // половина длины секундной стрелки
...
function run() {
    ...
    view1 = new ClockViewDOM(block1, model1);
    ...
    view2 = new ClockViewDOM(block2, model2);
