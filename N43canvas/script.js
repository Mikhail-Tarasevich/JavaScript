...
function run() {
    ...
    function viewTennis() {
        ...
        var update = this.update=function() {
            ...
            // field
            ctx.beginPath();
            ctx.rect(0, 0, thisModel.TENNIS_SIZE_X, thisModel.TENNIS_SIZE_Y);
            ctx.fillStyle = '#F0EE7F';
            ctx.fill();
            ctx.closePath();
            ctx.stroke();
            // ball
            ctx.beginPath();
            ctx.arc(thisModel.ball.x, thisModel.ball.y, thisModel.BALL_RADIUS, 0, DoublePI, true);
            ctx.fillStyle = '#EB2237';
            ctx.fill();
            ctx.closePath();
            ctx.stroke();
            // rocket 1
            ctx.beginPath();
            ctx.rect(thisModel.rocket1.x - (thisModel.ROCKET_WIDTH / 2), thisModel.rocket1.y - (thisModel.ROCKET_HEIGTH / 2), thisModel.ROCKET_WIDTH, thisModel.ROCKET_HEIGTH);
            ctx.fillStyle = '#09A85A';
            ctx.fill();
            ctx.closePath();
            ctx.stroke();
            // rocket 2
            ctx.beginPath();
            ctx.rect(thisModel.rocket2.x - (thisModel.ROCKET_WIDTH / 2), thisModel.rocket2.y - (thisModel.ROCKET_HEIGTH / 2), thisModel.ROCKET_WIDTH, thisModel.ROCKET_HEIGTH);
            ctx.fillStyle = '#171392';
            ctx.fill();
            ctx.closePath();
            ctx.stroke();
