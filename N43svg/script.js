...
function run() {
    ...
    function viewTennis() {
        ...
        var rocket2 = null;
        var tennis = null;
        var strSVG = '<svg height="500" width="800">';
        ...
        this.start=function(model, view) {
            ...
            strSVG = strSVG + '<rect id="svgtennis" x="0" y="0" width="' + thisModel.TENNIS_SIZE_X + '" height="' + thisModel.TENNIS_SIZE_Y + '" fill="#F0EE7F"/>';
            strSVG = strSVG + '<rect id="rocket1" x="' + (thisModel.rocket1.x - (thisModel.ROCKET_WIDTH / 2)) + '" y="' + (thisModel.rocket1.y - (thisModel.ROCKET_HEIGTH / 2)) + '" width="' + thisModel.ROCKET_WIDTH + '" height="' + thisModel.ROCKET_HEIGTH + '" fill="#09A85A"/>';
            strSVG = strSVG + '<rect id="rocket2" x="' + (thisModel.rocket2.x - (thisModel.ROCKET_WIDTH / 2)) + '" y="' + (thisModel.rocket2.y - (thisModel.ROCKET_HEIGTH / 2)) + '" width="' + thisModel.ROCKET_WIDTH + '" height="' + thisModel.ROCKET_HEIGTH + '" fill="#171392"/>';
            strSVG = strSVG + '<circle id="ball" cx="' + (thisModel.ball.x) + '" cy="' + (thisModel.ball.y) + '" r="' + thisModel.BALL_RADIUS + '" fill="#EB2237" />';

            tennis = thisView.getElementById('tennis');
            tennis.innerHTML = strSVG + '</svg>';
        }
        ...
        var update = this.update=function() {
            ...
            rocket1.setAttribute("y", (thisModel.rocket1.y - (thisModel.ROCKET_HEIGTH / 2)));

            rocket2 = thisView.getElementById('rocket2');
            rocket2.setAttribute("y", (thisModel.rocket2.y - (thisModel.ROCKET_HEIGTH / 2)));

            ball = thisView.getElementById('ball');
            ball.setAttribute("cx", (thisModel.ball.x));
            ball.setAttribute("cy", (thisModel.ball.y));
